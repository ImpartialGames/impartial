...
const services = [
  {
    ...
    descriptionEn: "From clean showcase sites to e-commerce — premium design, optimized SEO and fast rendering.",
    href: "/services/web",
    tags: ["Landing", "E-commerce", "Motion"],
    tagsEn: ["Landing", "E-commerce", "Motion"],
  },
  {
    icon: Smartphone,
    number: "02",
    ...
    descriptionEn: "Native iOS & Android experiences, fluid interfaces, intuitive UX, published on the App Store and Google Store.",
    href: "/services/mobile",
    tags: ["iOS", "Android", "React Native"],
    tagsEn: ["iOS", "Android", "React Native"],
  },
  {
    icon: Database,
    number: "03",
    title: "Backoffice & Logiciel",
    titleEn: "Back Office & Software",
    description: "Dashboards et outils internes sur-mesure, UX pensée pour la productivité, scalable dès le premier jour.",
    descriptionEn: "Custom dashboards and internal tools, UX built for productivity, scalable from day one.",
    href: "/services/backoffice",
    tags: ["Dashboard", "Auth", "API"],
    tagsEn: ["Dashboard", "Auth", "API"],
  },
  {
    icon: Layers,
    number: "04",
    ...
    descriptionEn: "End-to-end digital strategy, unified design system, multi-platform, consistent from start to finish.",
    href: "/services/360",
    tags: ["Design System", "Multi-plateforme", "Stratégie"],
    tagsEn: ["Design System", "Multi-platform", "Strategy"],
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <h2 className="text-[40px] md:text-[64px] leading-[1.05] tracking-[-0.02em] text-white mb-6">
            <span className="block prisme-display">{t("L'ensemble de la", "Every link in the")}</span>
            <span className="block prisme-italic-grad">{t("chaîne digitale.", "digital chain.")}</span>
          </h2>
          <p className="text-white/55 text-base md:text-lg leading-relaxed">
            {t(
              "Du concept à la production, chaque discipline maîtrisée, pour des livrables à la hauteur de votre ambition.",
              "From concept to production, every discipline mastered — deliverables that live up to your ambition."
            )}
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <p className="text-[15px] text-white/55 leading-relaxed flex-1 mb-6">
                  {t(s.description, s.descriptionEn)}
                </p>
