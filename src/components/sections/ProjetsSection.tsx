...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <Link
        to={project.url}
        className={`group flex flex-col items-start gap-0 lg:gap-16 ${isEven ? "lg:flex-row" : "lg:flex-row-reverse"}`}
        aria-label={`Voir le projet ${project.title}`}
      >
        {/* Visual */}
        <div
          className="relative w-full lg:w-[55%] flex-shrink-0 overflow-hidden"
          style={{
        ...
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 70% 50% at 50% 110%, rgba(109,91,208,0.18) 0%, transparent 70%)",
            }}
          />
          {project.image ? (
            <img
