...
const project = {
  title: "Altarys Group",
  subtitle: "Plateforme DeFi avec dashboard administratif complet",
  category: "Dashboard / SaaS",
  client: "Altarys Group",
  year: "2025",
  duration: "8 semaines",
  url: "https://altarys-group.fr/",
  description: "Altarys Group accompagne les professionnels de la finance dans leur transition vers l'écosystème DeFi et les actifs tokenisés. Le projet nécessitait une plateforme complète : site vitrine qui vulgarise des concepts complexes, et un dashboard de gestion pour les opérations internes. L'interface devait inspirer confiance dans un secteur où la crédibilité est tout.",
  challenges: [
    "Vulgariser des concepts DeFi complexes pour un public non-initié",
    "Concevoir un dashboard intuitif pour la gestion multi-services",
    "Assurer la sécurité des données financières sensibles",
  ],
  solutions: [
    "Design épuré avec hiérarchie visuelle rigoureuse et copywriting clair",
    "Architecture modulaire avec composants réutilisables",
    "Authentification sécurisée et gestion des rôles différenciée",
  ],
  stack: ["React", "TypeScript", "Tailwind CSS", "Supabase", "Framer Motion"],
};

const nav = {
  prev: { href: "/portfolio/eclipsia", label: "Eclipsia" },
  next: { href: "/portfolio/prophecia", label: "Guardian Of Prophecia" },
};
          ...
          >
            {[
              ...
              <div key={meta.label}>
                ...
                <p className="text-[0.9375rem]" style={{ color: "var(--ig-ink)", fontWeight: 500 }}>
                  {meta.value}
                </p>
              </div>
            ))}
