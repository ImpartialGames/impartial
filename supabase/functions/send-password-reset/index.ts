...
serve(async (req) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      to: [email],
      subject: "Réinitialisation de votre mot de passe — Impartial",
      html: `
<!DOCTYPE html>
<html lang="fr">
      ...
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;">
        ...
        <tr><td style="background:#111116;border:1px solid #27272a;border-radius:16px;padding:36px 32px;">
          ...
          <div style="text-align:center;margin-bottom:24px;">
            <div style="display:inline-block;background:linear-gradient(135deg,rgba(124,58,237,0.15),rgba(167,139,250,0.15));border:1px solid rgba(167,139,250,0.3);border-radius:50%;width:56px;height:56px;line-height:56px;font-size:28px;">🔑</div>
          </div>

          <p style="margin:0 0 4px;font-size:13px;color:#a78bfa;font-weight:600;text-transform:uppercase;letter-spacing:1.5px;text-align:center;">Mot de passe</p>
          <h2 style="margin:0 0 20px;font-size:20px;color:#fafafa;font-weight:600;text-align:center;">Réinitialisez votre mot de passe</h2>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);border-radius:10px;margin-bottom:24px;">
            <tr><td style="padding:14px 18px;">
              <p style="margin:0;font-size:13px;color:#fbbf24;line-height:1.5;">
                ⚠️ Ce lien expire dans 1 heure. Si vous n'avez pas demandé cette réinitialisation, ignorez simplement cet email.
              </p>
            </td></tr>
          </table>
